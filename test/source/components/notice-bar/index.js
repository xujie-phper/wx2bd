...
Component({
  ...
  methods: {
    initAnimation() {
      wx.createSelectorQuery().in(this).select('.u-noticebar-content-wrap').boundingClientRect((wrapRect) => {
        wx.createSelectorQuery().in(this).select('.u-noticebar-content').boundingClientRect((rect) => {
